;;; abunbux-theme.el --- Awesome Emacs color theme on white background -*- lexical-binding: t; -*-
...
(let ((class '((class color) (min-colors 89)))
      ...
      ;; generic colors
      (cancel '(:slant italic :strike-through nil :foreground "gray30"))
      ...
      (_highlight-line '(:background "#FFFFD7")) ; #F5F5F5
      (_highlight-line-gnus '(:background "#DAEAFC")) ; defined in `gnus-leuven.el'
      (link '(:weight normal :foreground "#04cca7"))
      ...
      (_mail-read '(:weight normal :foreground "#86878B"))
      (_mail-ticked '(:weight bold :background "#FBE6EF"))
      (mail-to '(:family "Sans Serif" :underline nil :foreground "#006DAF"))
      (_mail-unread '(:weight bold :foreground "black"))
      (marked-line '(:weight bold :foreground "white" :background "red"))
      (match '(:weight bold :background "#1f1f1f")) ; occur patterns
      ...
      ;; (paren-matched '(:background "#3e3b32" :foreground "white"))
      (paren-matched '(:background unspecified :foreground "red" :weight bold))
      (paren-unmatched '(:underline "red" :background "navy" :foreground "white"))

      (region '(:weight bold :distant-foreground unspecified  :background "#09414f" :foreground unspecified))
      (shadow '(:foreground "#7F7F7F"))
      (string '(:foreground "#05a805"))
      ;; (string '(:foreground "#cf4d02"))
      (subject '(:family "Sans Serif" :weight bold :foreground "black"))
      (symlink '(:foreground "deep sky blue"))
      (volatile-highlight '(:underline nil :background "#586e75" :foreground "#002b36"))
  ...
  (custom-set-faces
   `(default ((,class (
                       ;; Указывает не наследовать свойства от других стилей. Это «фундамент».
                       :inherit             nil
                       ;; Отключает точечный узор (использовалось в старых ч/б мониторах для имитации серого фона).
                       :stipple             nil
                       ;; Выключает инверсию (если t, текст и фон поменялись бы местами).
                       :inverse-video       nil
                       :box                 nil
                       :strike-through      nil
                       :overline            nil
                       :underline           nil
                       :foreground          "#c5c9d1"
                       ;; Цвет, который Emacs применит, если цвет текста и фона станут слишком похожими (чтобы текст остался читаемым):
                       ;; :distant-foreground  "#ecf0f1"      ; «Мягкий жемчуг»
                       ;; :distant-foreground "#93a1a1"       ; «Песочный серый»
                       ;; :distant-foreground "#839496"       ; «Приглушенная бирюза»
                       :distant-foreground "#93a1a1"
                       :background          "#002b36"
                       :height              160
                       :slant               normal
                       :weight              normal
   ...
   `(cursor ((,class (:background "#ced23a"))))
   ...
   `(secondary-selection ((,class ,match)))

   ;; '(isearch ((,class ())))
   `(isearch ((,class (:weight bold :underline "#FF9632" :foreground "#eeeeec" :background "#ce5c00"))))
   ...
   `(minibuffer-prompt ((,class (:weight bold :foreground "#FFFF00"))))
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground "#268bd2"))))
   `(font-lock-comment-delimiter-face ((,class (:foreground "#5e5c5c"))))
   `(font-lock-comment-face ((,class (:slant italic :foreground "dim gray"))))
   ...
   `(font-lock-keyword-face ((,class (:bold nil :foreground "#2aa198"))))
   ...
   `(font-lock-type-face ((,class (:weight normal :foreground "#7d42c9"))))
   ;; `(font-lock-type-face ((,class (:weight normal :foreground "#268bd2"))))                          ; можно попробовать
   `(font-lock-variable-name-face ((,class (:weight normal :foreground "#858503"))))
   `(font-lock-warning-face ((,class (:bold t :weight bold :foreground "red"))))
   ...
   `(hl-line ((,class (:inherit unspecified :background "#073642" :foreground unspecified))))
   `(hl-tags-face ((,class (:background "#FEFCAE"))))
   `(line-number ((,class ,cancel)))
   ;; Номер текущей строки (сделаем его ярким)
   `(line-number-current-line ((,class (:foreground "#ecf0f1" :weight bold :distant-foreground unspecified))))
   ;; `(line-number-current-line ((,class ( :inverse-video t :weight bold))))
   ...
   `(circe-highlight-all-nicks-face ((,class (:foreground "blue" :background "#F0F0F0"))))
   `(circe-highlight-nick-face ((,class (:foreground "#009300" :background "#F0F0F0"))))
   ...
   `(lui-highlight-face ((,class (:box '(:line-width 1 :color "#CC0000") :foreground "#CC0000" :background "#FFFF88"))))
   ...
   `(org-block ((,class (:foreground "#B8B8B8" :background "#003542"))))
   ...
   `(org-code ((,class (:foreground "#f08a71" :background "#8794fa"))))
